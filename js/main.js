...
var createNavigationBar = function() {
  ...
  var $cart = $('<input type="image" id="cart" src="images/icons/supermarket.svg" name="submit"/>').appendTo($cart);
  ...
  // $('<button type="submit" class="view-cart--button">View Cart</button>').appendTo($cart);
